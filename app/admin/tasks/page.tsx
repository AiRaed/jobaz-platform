...
import AdminTasksBoard from '@/components/admin/tasks/AdminTasksBoard'

export const metadata = {
  title: 'Admin Tasks | JobAZ',
  description: 'Internal JobAZ admin task board',
}
      ...
      <header className="mb-8 pb-6 border-b border-slate-800/60">
        ...
        <div className="flex items-start gap-3">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl border border-violet-500/30 bg-violet-950/30 shrink-0">
            <ListTodo className="w-6 h-6 text-violet-300" />
          </div>
          <div>
            <p className="text-[10px] uppercase tracking-widest text-violet-300 mb-1">
              JobAZ Admin
            </p>
            <h1 className="text-2xl md:text-3xl font-bold text-slate-50">Admin Tasks</h1>
            <p className="text-sm text-slate-400 mt-2 max-w-2xl">
              Track actions suggested by AI Manager, Technical Reports, Affiliate Scout, or
              manual admin work.
            </p>
          </div>
        </div>
