...
description:
'JobAZ helps you build professional CVs, discover career paths with Build Your Path, find jobs, and prepare for interviews using AI.', keywords: [
 'CV generator',
'resume builder',
 'AI resume',
 'ATS optimization',
...
icons: {
icon: [
{ url: '/favicon.svg', type: 'image/svg+xml' }, { url: '/favicon-32x32.png', sizes: '32x32', type: 'image/png' },
...
<head>
 ...
 <Script
src="https://www.googletagmanager.com/gtag/js?id=G-B6F0REFBQR"
strategy="afterInteractive"
 ...
 gtag('js', new Date());
 gtag('config', 'G-B6F0R0FB0R');
 `}
 </Script>

 {/* Structured Data – Build Your Path */} <Script
id="jobaz-structured-data" type="application/ld+json"
 strategy="afterInteractive"
>
 {JSON.stringify({
