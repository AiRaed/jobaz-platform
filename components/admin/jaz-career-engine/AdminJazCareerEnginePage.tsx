    ...
    <AppShell>
      <header className="mb-6 border-b border-slate-800/60 pb-5">
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          <Link
            href="/admin#uk-career-assistant"
        ...
        <div className="flex items-start gap-3">
          <div className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-cyan-500/30 bg-cyan-950/30">
            <Brain className="h-5 w-5 text-cyan-300" aria-hidden />
          </div>
          <div className="min-w-0">
            <p className="mb-1 text-[10px] uppercase tracking-widest text-cyan-300/90">
              UK Career Assistant · Engine
            </p>
            <h1 className="text-2xl font-bold text-slate-50">Career Assistant Engine</h1>
            <p className="mt-1.5 max-w-3xl text-sm text-slate-400">
              Engine health across Career Assistant paths — JAZ status, assistant logs, behaviour
              analytics, course matching, missing affiliates, and test tools (admin decides what to
              change).
            </p>
            <div className="mt-4 flex flex-wrap gap-2">
              <Link
                href="/uk-career-assistant"
                className="inline-flex min-h-9 items-center justify-center rounded-xl bg-cyan-600 px-3.5 text-xs font-semibold text-white hover:bg-cyan-500"
              >
      ...
      <nav className="mb-6 flex flex-wrap gap-2" aria-label="Career Assistant Engine sections">
        {TABS.map((t) => (
          <button
            key={t.id}
            type="button"
