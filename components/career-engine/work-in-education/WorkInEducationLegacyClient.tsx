...
/**
 * LEGACY Work in My Education flow (Career Engine conversation + education-path API).
 * Kept intact for rollback when CAREER_KNOWLEDGE_ENGINE_WORK_IN_EDUCATION_V1 is off.
 * Do not delete — feature-flag routing switches between this and the knowledge-engine wizard.
 */
...
export default function WorkInEducationLegacyClient() {
  return (
