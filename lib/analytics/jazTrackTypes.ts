...
export type JazActivityEventType =
  ...
  | 'wie_courses_question_shown'
  | 'wie_completed_courses_selected'
  | 'wie_course_recommended'
  | 'wie_course_apply_clicked'
  | 'wie_course_save_interest_clicked'
  | 'wie_missing_provider_logged'
  | 'job_search_clicked'
  | 'job_viewed'
  | 'job_saved'
  | 'job_apply_clicked'
