 ...
 *   scripts/career-library-engineering/legacy-archives/populate-career-library-automotive-engineering-roles.ts.archived.txt
 */

import { refuseLegacyEngineeringAcademicPopulate } from './career-library-engineering/refuseLegacyAcademicPopulate'

refuseLegacyEngineeringAcademicPopulate('populate-career-library-automotive-engineering-roles.ts')
