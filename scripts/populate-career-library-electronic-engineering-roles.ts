 ...
 *   scripts/career-library-engineering/legacy-archives/populate-career-library-electronic-engineering-roles.ts.archived.txt
 */

import { refuseLegacyEngineeringAcademicPopulate } from './career-library-engineering/refuseLegacyAcademicPopulate'

refuseLegacyEngineeringAcademicPopulate('populate-career-library-electronic-engineering-roles.ts')
