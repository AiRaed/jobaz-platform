 ...
 *   scripts/career-library-engineering/legacy-archives/populate-career-library-environmental-engineering-roles.ts.archived.txt
 */

import { refuseLegacyEngineeringAcademicPopulate } from './career-library-engineering/refuseLegacyAcademicPopulate'

refuseLegacyEngineeringAcademicPopulate('populate-career-library-environmental-engineering-roles.ts')
