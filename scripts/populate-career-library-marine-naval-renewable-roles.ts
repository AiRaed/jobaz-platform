 ...
 *   scripts/career-library-engineering/legacy-archives/populate-career-library-marine-naval-renewable-roles.ts.archived.txt
 */

import { refuseLegacyEngineeringAcademicPopulate } from './career-library-engineering/refuseLegacyAcademicPopulate'

refuseLegacyEngineeringAcademicPopulate('populate-career-library-marine-naval-renewable-roles.ts')
