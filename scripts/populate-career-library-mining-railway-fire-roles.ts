 ...
 *   scripts/career-library-engineering/legacy-archives/populate-career-library-mining-railway-fire-roles.ts.archived.txt
 */

import { refuseLegacyEngineeringAcademicPopulate } from './career-library-engineering/refuseLegacyAcademicPopulate'

refuseLegacyEngineeringAcademicPopulate('populate-career-library-mining-railway-fire-roles.ts')
