 ...
 *   scripts/career-library-engineering/legacy-archives/populate-career-library-petroleum-engineering-roles.ts.archived.txt
 */

import { refuseLegacyEngineeringAcademicPopulate } from './career-library-engineering/refuseLegacyAcademicPopulate'

refuseLegacyEngineeringAcademicPopulate('populate-career-library-petroleum-engineering-roles.ts')
