 ...
 *   scripts/career-library-engineering/legacy-archives/populate-career-library-quantity-surveying-roles.ts.archived.txt
 */

import { refuseLegacyEngineeringAcademicPopulate } from './career-library-engineering/refuseLegacyAcademicPopulate'

refuseLegacyEngineeringAcademicPopulate('populate-career-library-quantity-surveying-roles.ts')
