 ...
 *   scripts/career-library-engineering/legacy-archives/populate-career-library-structural-geotechnical-water-roles.ts.archived.txt
 */
...
refuseLegacyEngineeringAcademicPopulate(
  'populate-career-library-structural-geotechnical-water-roles.ts'
)
